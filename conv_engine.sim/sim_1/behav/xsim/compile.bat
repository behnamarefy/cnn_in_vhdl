...
REM
REM Generated by Vivado on Sun Jul 02 10:27:09 +0330 2023
...
echo "xvhdl --incr --relax -prj conv_eng_tb_vhdl.prj"
call xvhdl  --incr --relax -prj conv_eng_tb_vhdl.prj -log xvhdl.log
