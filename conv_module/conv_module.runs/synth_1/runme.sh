...
HD_PWD='D:/project/behnam/behnam/arefi/conv_module/conv_module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv_module.tcl
